...
#ifndef POLICY_OPERATIONS_H
#define POLICY_OPERATIONS_H
#include <type_traits>
...
struct PolicyDeriveFil_<PolicyContainer<TCur, TProcessings...>,
                        ...
                        TCompPoliCont>
{
    constexpr static bool dupe = PolicyExist<TCompPoliCont, TCur>; //不能自己继承自己
                    ...
                    PolicyContainer<TFilteredPolicies...>>
{
    using TNewFiltered = std::conditional_t<IsSubPolicyContainer<TCurPolicy>,
                                            PlainPolicy_<PolicyContainer<TPolicies...>, // subpolicycontainer 丢掉
                                                         PolicyContainer<TFilteredPolicies...>>,
...
{
    using tmp1 = typename SPP_<TPolicyContainer, TLayerName>::type; // 符合的 subpolicy
    using tmp2 = PlainPolicy<TPolicyContainer>;                     // 最外层的非subpolicy
