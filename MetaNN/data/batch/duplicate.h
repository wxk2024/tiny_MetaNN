...
namespace MetaNN {
    ...
    public:
        ...
        bool operator==(const Duplicate<TData> &val) const {
            const DuplicateImp<TData, CategoryTags::Matrix> &tmp = static_cast<const DuplicateImp<TData,
                CategoryTags::Matrix> &>(val);
    ...
    public:
        ...
        bool operator==(const Duplicate<TData> &val) const {
            const DuplicateImp<TData, CategoryTags::Scalar> &tmp = static_cast<const DuplicateImp<TData,
                CategoryTags::Scalar> &>(val);
            return (tmp.m_data == m_data) && (tmp.m_batchNum == m_batchNum);
        }
